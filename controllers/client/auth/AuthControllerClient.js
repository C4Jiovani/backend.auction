...
// export const sendMailVerification = (req,res) =>{
  //   const {email} = req.body
...
export const sendVerificationCode = (req, res) => {
  ...
  db.query(updateQuery, [code, email], (updateError, updateResults) => {
    ...
    const transporter = nodemailer.createTransport({
      service: 'Gmail',
      auth: {
        user: 'rakotorisonlandry@gmail.com', // Remplacez par votre adresse email Gmail
        pass: 'mpea dxeb unhw iewy ' // Remplacez par le mot de passe de votre compte Gmail
      }
    });
